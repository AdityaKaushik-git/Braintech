...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="relative min-h-screen flex items-center pt-20 bg-gradient-to-br from-[#0a1628] via-[#0f2040] to-[#091525] overflow-hidden"
        aria-label="Hero — Braintech Computer Academy"
      >
        <div className="absolute inset-0 grid-pattern opacity-50" aria-hidden="true" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_70%_50%,rgba(29,78,216,0.18)_0%,transparent_70%),radial-gradient(ellipse_40%_40%_at_10%_80%,rgba(6,182,212,0.1)_0%,transparent_60%)] pointer-events-none" aria-hidden="true" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/8 border border-white/15 mb-6"
              >
                ...
                <span className="text-xs text-slate-300 font-medium">
                  Rated <strong className="text-white">5.0</strong> by 578+ students on Justdial
                </span>
              </div>

              {/* Headline */}
              <HeroAnim delay={200}>
                <h1 className="font-display text-white text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.1] tracking-tight mb-5">
                  Build Skills.<br />
                  <span
            ...
            >
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-white/10 animate-float">
                ...
                />
                <div
                  className="w-full h-72 sm:h-96 bg-gradient-to-br from-blue-900 to-slate-900 hidden items-center justify-center"
                  aria-hidden="true"
                >
              ...
              <div
                className="absolute -bottom-4 -left-4 z-20 bg-white rounded-xl p-3.5 shadow-xl border border-gray-100 flex items-center gap-3"
              ...
              <div
                className="absolute -top-3 -right-3 z-20 bg-white rounded-xl p-3 shadow-xl border border-gray-100 flex items-center gap-2.5 max-w-[180px]"
