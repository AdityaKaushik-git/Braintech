    ...
    <section id="reviews" className="section-padding bg-white" aria-labelledby="reviews-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal animation="zoom-in" delay={100} className="relative z-10">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-12 p-6 bg-slate-50 rounded-2xl border border-slate-100 max-w-2xl mx-auto shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="text-center group">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 text-blue-600 text-xs hover:underline mt-2 font-medium"
              >
                    ...
                    <div key={t.id} className="w-full flex-shrink-0 px-2">
                      ...
                      >
                        ...
                        <footer className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-slate-400">via {t.source}</span>
                        </footer>
                      </div>
                    </div>
                  ))}
              ...
              {testimonials.length > 1 && (
                <div className="flex items-center justify-center gap-4 mt-8">
                  <button
                    onClick={prev}
                    disabled={current === 0}
                    className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-slate-600 hover:border-blue-400 hover:text-blue-600 transition-colors disabled:opacity-30"
                    ...
                    {testimonials.map((_, i) => (
                      <button
                        ...
                        className={`h-2 rounded-full transition-all duration-300 ${
                          i === current ? 'bg-blue-600 w-6' : 'bg-gray-300 hover:bg-gray-400 w-2'
                        }`}
